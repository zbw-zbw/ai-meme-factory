...
import { DownloadIcon, CopyIcon, RefreshIcon, ShareIcon, CloseIcon, EditIcon } from "@/components/Icons";
...
export default function MemeResult({ item, index, onRegenerate, isRegenerating, onEdit }: MemeResultProps) {
  ...
  return (
    <div
      className="relative overflow-hidden rounded-2xl glass-card shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-lg"
    ...
    >
      ...
      {isRegenerating && (
        <div className="absolute inset-0 z-10 flex items-center justify-center bg-bg/60 backdrop-blur-sm rounded-2xl">
