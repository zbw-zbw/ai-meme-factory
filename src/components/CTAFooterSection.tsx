      ...
      <section className="px-4 py-20 sm:px-6">
        <div className="mx-auto max-w-[1200px]">
          <FadeInWrapper className="text-center">
            ...
            <Link
              href="/create"
              className="inline-flex items-center gap-2 animate-pulse-glow rounded-xl px-8 py-4 text-center text-[1.1rem] font-bold text-white no-underline transition-transform duration-200 hover:scale-105 sm:px-10 sm:text-[1.2rem]"
